 ...
 */
public class DetalheProdutoCliente extends javax.swing.JFrame {

    /**
	 * 
	 */
	private static final long serialVersionUID = -9116969774750633206L;
	@SuppressWarnings("unused")
	private String s;
    private JFrame jC;
    private ProdutoVO pVo;
    @SuppressWarnings("unused")
	private Object labImagem;
            
    public DetalheProdutoCliente(ProdutoVO pVo, JFrame jC) {
        initComponents();
   ...
   private void abreImagem(){
    ...
    private void butComprarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butComprarActionPerformed
       ...
       JanelaCliente janelCli = (JanelaCliente) this.jC;
       janelCli.atualizaQntComprada(quantidade);
       janelCli.atualizaValorTotal(this.pVo.getValorUnitario(), quantidade);
       janelCli.atualizaCarrinho("" + janelCli.getQntComprada(), "" + ("R$ " + String.valueOf((janelCli.getValorTotal()) + "0").replace(".", ",")));
       janelCli.arrayQntCodProd(this.pVo.getCodigoProduto(), quantidade);
       this.dispose();
