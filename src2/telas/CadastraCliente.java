...
public class CadastraCliente extends javax.swing.JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5956726683626585315L;
	private String senha, nome, email, pais, estado, cidade, bairro, rua, telefone;
    private int codigoCliente, codigoEndereco, nroCasa;
    ...
    private void initComponents() {
                ...
                .addGroup(painelCadastrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(painelCadastrarLayout.createSequentialGroup()
                        .addGroup(painelCadastrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(painelCadastrarLayout.createSequentialGroup()
                                .addComponent(labelPais, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(painelCadastrar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 334, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void butGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butGerarActionPerformed
        try {
            int codigo = c.codigoClienteMax() + 1;
    ...
    private void preencheCampo() throws CampoVazioException, NoSuchAlgorithmException, UnsupportedEncodingException, ClassNotFoundException, SQLException {
        if(this.labelCodigoGerado.getText().equals("")
            ...
            codigoCliente = Integer.parseInt(this.labelCodigoGerado.getText());
    ...
    private void butCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butCadastrarActionPerformed
        try {
            ...
            ClienteVO cVo = new ClienteVO(codigoCliente, codigoEndereco, senha, email, nome, telefone);
            e.criarEndereco(eVo);
            c.criarCliente(cVo);
            JOptionPane.showMessageDialog(null, "O cliente foi cadastrado com sucesso!", "Confirmação", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
