...
public class FuncionarioDAO {
    ...
    public ArrayList<FuncionarioVO> buscarFuncionarioAll() throws SQLException, ClassNotFoundException{
            ArrayList<FuncionarioVO> retorno = new ArrayList<FuncionarioVO>();
            Connection connection = ConectaBD.getConnection();
