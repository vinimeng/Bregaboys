 ...
 */
public class CadastraTransportadora extends javax.swing.JFrame {
    
    private String senha, nome, email, pais, estado, cidade, bairro, rua, telefone;
    private int codigoTransportadora, codigoEndereco, nroCasa;
    private EnderecoDAO e;
    private TransportadoraDAO c;
    
    public CadastraTransportadora() {
        initComponents();
        this.setLocationRelativeTo(null);
        e = new EnderecoDAO();
        c = new TransportadoraDAO();
        try {
    ...
    private void butGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butGerarActionPerformed
        try {
            int codigo = c.codigoTransportadoraMax() + 1;
            this.labelCodigoGerado.setText("" + codigo);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(CadastraTransportadora.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void preencheCampo() throws CampoVazioException, NoSuchAlgorithmException, UnsupportedEncodingException, ClassNotFoundException, SQLException {
        if(this.labelCodigoGerado.getText().equals("")
            ...
            codigoTransportadora = Integer.parseInt(this.labelCodigoGerado.getText());
    ...
    private void butCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butCadastrarActionPerformed
        try {
            ...
            TransportadoraVO cVo = new TransportadoraVO(codigoEndereco, codigoTransportadora, email, nome, telefone);
            e.criarEndereco(eVo);
            c.criarTransportadora(cVo);
            JOptionPane.showMessageDialog(null, "A transportadora foi cadastrado com sucesso!", "Confirmação", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
            ...
            Logger.getLogger(CadastraTransportadora.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, "Não foi possível cadastrar a transportadora!\nNoSuchAlgorithmException", "Erro", JOptionPane.ERROR_MESSAGE);
            this.limparCampos();
